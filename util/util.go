...
func BuildClientConfig(client model.Client, server model.Server, setting model.GlobalSetting) string {
	...
	strConfig := "# CONFIDENTIAL — DO NOT DISTRIBUTE\n" +
		"# This file contains private cryptographic keys.\n" +
		"# Sharing this file may compromise your network security.\n" +
		"# Generated by WireGuard UI — for authorized use only.\n\n" +
		"[Interface]\n" +
		clientAddress +
		clientPrivateKey +
		clientDNS +
